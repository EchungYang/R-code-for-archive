...
## This markdown file is a demo for the intern application at Cambridge Cognition. For confidentiality, all the name of the dataframe has been refered to as df. These codes are picked from the script of projects I have done or currently working with. 
